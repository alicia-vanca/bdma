package com.app.sync.repository;

import com.app.common.exception.RepositoryException;
...
public class FileRepository {
     ...
     * - On conflict (device_id, path), updates status, file_size, create_date, and type.
     */
