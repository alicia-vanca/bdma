package com.app.common.modules.databaserecovery.aspects;
...
public class DatabaseConnectionAspect {
    ...
    public DatabaseConnectionAspect(DataSource dataSource, DatabaseRecoveryService databaseRecoveryService) {
        ...
        try {
            ...
            if (!databaseAvailable) {
                ...
                if (isAlertShowing.compareAndSet(false, true)) {
                    try {
                        databaseRecoveryService.restoreSourceFromBackup();
